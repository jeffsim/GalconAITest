...
public static class AIDebugger
{
    ...
    // internal static AIDebuggerEntryData AddPerformedAction_ConstructBuildingInEmptyNode(AIDebuggerEntryData parent, AI_NodeState fromNode, AI_NodeState toNode, int numSent, BuildingDefn buildingDefn, float finalActionScore, int actionNum, int curDepth)
    // {
    //     if (!ShouldTrackEntries) return null;
    //     var newEntry = AIDebuggerEntryData.GetFromPool(
    //                                 AIActionType.ConstructBuildingInEmptyNode,
    //                                 fromNode,
    //                                 toNode,
    //                                 numSent,
