...
public partial class PlayerAI
{
    ...
    AIAction RecursivelyDetermineBestAction(int curDepth, float scoreOnEntry)
    {
        ...
        bestAction.ThisActionScore = scoreOnEntry;
        if (curDepth == maxDepth || aiTownState.IsGameOver())
        {
            ...
            bestAction.ScoreAfterSubactions = scoreOnEntry;
            return bestAction;
        }
        ...
        bestAction.ScoreAfterSubactions = 0;
       ...
       //     TryAttackFromNode(node, ref bestAction, curDepth, recurseCount, debugOutput_ActionsTried++);
        ...
        if (bestAction.ScoreAfterSubactions <= scoreOnEntry)
        {
            ...
            bestAction.ScoreAfterSubactions = scoreAfterActionAndBeforeSubActions;
